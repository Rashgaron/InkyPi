...
class Weather(BasePlugin):
        ...
        try:
            if weather_provider == "OpenWeatherMap":
                ...
                if settings.get('weatherTimeZone', 'locationTimeZone') == 'locationTimeZone':
                    ...
                    template_params = self.parse_weather_data(weather_data, aqi_data, wtz, units, time_format, home_assistant_api_key, lat)
                else:
                    logger.info("Using configured timezone for OpenWeatherMap data.")
                    template_params = self.parse_weather_data(weather_data, aqi_data, tz, units, time_format, home_assistant_api_key, lat)
    ...
    def parse_weather_data(self, weather_data, aqi_data, tz, units, time_format, home_assistant_api_key, lat):
